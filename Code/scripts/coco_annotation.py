...
flags.DEFINE_string('coco_data', './examTest.pkl', 'path to coco data')
...
flags.DEFINE_string('image_path', "test", 'path to image val')
flags.DEFINE_string('anno_path_val', '../data/dataset/test.txt', 'path to classes file')
